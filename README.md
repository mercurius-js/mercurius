...
* `subscription`: Boolean | Object. Enable subscriptions. It uses [mqemitter](https://github.com/mcollina/mqemitter) when it is true and exposes the pubsub interface to `app.pubsub`. To use a custom emitter set the value to an object containing the emitter.
