...
Federation support is managed by the plugin [`@mercurius/federation`](https://github.com/mercurius-js/mercurius-federation) and the plugin [`@mercurius/gateway`](https://github.com/mercurius-js/mercurius-gateway)
