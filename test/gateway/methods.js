...
test('calling defineLoaders throws an error in gateway mode', async (t) => {
  ...
  try {
    ...
    t.is(err.message, 'Calling defineLoaders method when plugin is running in gateway mode is not allowed')
  }
})
...
test('calling defineResolvers throws an error in gateway mode', async (t) => {
  ...
  try {
    ...
    t.is(err.message, 'Calling defineResolvers method when plugin is running in gateway mode is not allowed')
  }
})
...
test('calling extendSchema throws an error in gateway mode', async (t) => {
  ...
  try {
    ...
    t.is(err.message, 'Calling extendSchema method when plugin is running in gateway mode is not allowed')
    t.end()
  }
})
