...
function createConnectionHandler ({ schema, subscriber, fastify, onConnect, lruGatewayResolvers, entityResolversFactory }) {
...
module.exports = function (fastify, opts, next) {
  const { getOptions, schema, subscriber, verifyClient, onConnect, lruGatewayResolvers, entityResolversFactory } = opts
