...
function createConnectionHandler ({ schema, subscriber, fastify, lruGatewayResolvers, entityResolversFactory, subscriptionContextFn }) {
...
module.exports = function (fastify, opts, next) {
  const { getOptions, schema, subscriber, verifyClient, lruGatewayResolvers, entityResolversFactory, subscriptionContextFn } = opts
