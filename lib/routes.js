...
module.exports = async function (app, opts) {
  ...
  if (opts.ide || opts.graphiql) {
    ...
    if (opts.ide === true || opts.ide === 'graphiql' || opts.graphiql === true) {
      app.register(
        (instance, opts, next) => {
          instance.get('/graphiql', (req, reply) => {
            reply.sendFile('graphiql.html')
          })
          instance.get('/graphiql/main.js', (req, reply) => {
            reply.sendFile('main.js')
          })
          instance.get('/graphiql/sw.js', (req, reply) => {
            reply.sendFile('sw.js')
          })
          instance.get('/graphiql/config.js', (req, reply) => {
            reply.header('Content-Type', 'application/javascript').send(`window.GRAPHQL_ENDPOINT = '${graphqlPath}'`)
          })
          next()
        },
        { prefix: graphqlPath }
    ...
    if (opts.ide === 'playground') {
      app.register(
        (instance, opts, next) => {
          instance.get('/playground', (req, reply) => {
            reply.sendFile('playground.html')
          })
          instance.get('/playground/init.js', (req, reply) => {
