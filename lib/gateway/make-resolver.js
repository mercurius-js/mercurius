...
function makeResolver ({ service, createOperation, transformData, isQuery, isReference }) {
  return function (parent, args, context, info) {
    ...
    // TODO: implement caching strategy as createOperation and print are expensive.
    ...
    if (isQuery) {
      ...
      return reply[kEntityResolvels][`${service.name}Entity`]({ query, variables }).then(transformData)
    }
  }
}
