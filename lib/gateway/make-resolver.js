  ...
  return async function (parent, args, context, info) {
    ...
    if (isQuery) {
      ...
      if (response.json.errors) {
        context.errors = context.errors ? [...context.errors, ...response.json.errors] : [response.json.errors]
      }
      if (response.json.extensions) {
        context.extensions = context.extensions ? { ...context.extensions, ...response.json.extensions } : { ...response.json.extensions }
      }
