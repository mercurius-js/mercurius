...
const { hooksRunner, preExecutionHooksRunner, hookRunner, preParsingHookRunner, onResolutionHookRunner, onEndHookRunner, onConnectionCloseHookRunner, onConnectionErrorHookRunner } = require('./hooks')
